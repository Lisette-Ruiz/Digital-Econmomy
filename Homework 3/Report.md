...
- Before starting it is important to mention that market changes are the main indicator for regulation to be reduced or eliminated completely. Technological innovations are becoming ever more embedded in our day-to-day lives, generating valuable new opportunities but also digital risks that are increasing exponentially. Now, to begin by understanding the context, we must define what the regulatory frameworks are; These refer to the division of power distributed in the institutions involved, be they norms, rules, implementation strategies, among others. It is worth mentioning that there is normal physical commerce, which we know every day, and now with Amazon, Shein and among other companies they are implementing digital commerce, that is, paying for the product-service through digital payments such as Pay Pal, to Through blockchain or some exchanges that are carried out, on the other hand, it is worth mentioning that there are frameworks that seek to benefit this type of digital thing through the security of your data. To be effective, governments have to redesign the way they regulate the world’s rapidly growing digital economy, taking into account four new, parallel, emerging digital challenges: Scope; Scale; Digital products and digital behavior. 
- 
...
6) What does the book refer to Data valuation and how organizations implement it?
 ...
 24)Mention the aspect which presents  ethical  challenges  since  data is  changed  as  it  moves  from  system  to  system and what are their risks included.
    R: Data  integration, and it's risks are mainly included into these 4:  Limited knowledge  of  data’s  origin  and  lineage; Data of poor quality;Unreliable Metadata and No documentation  of  data remediation  history.
